...
$emailConsulta=$_POST['mailInsertado'];
$codigo=$_POST['codigoInsertado'];
$_SESSION['emailConsulta'] = $emailConsulta;


$sql = "SELECT * FROM reservas WHERE email = '$emailConsulta' AND codigo = '$codigo'";
...
if ($result->num_rows > 0) {
    // Si hay filas es correcto
    header("Location: mostrarReservas.php"); 
 
} else {
    // Sino mensajito que lo intente otra vez
